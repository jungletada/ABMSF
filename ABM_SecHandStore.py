...
class SecondHandStores(Agent):
    ...
    def update_volumes_eol_recycled(self, agent, eol_path, volume, mass_volume_recycler, storage):
        """
    ...
    def update_price_scdhand(self):
        self.scd_hand_price = self.scndhand_mkt_pric_rate * self.model.fsthand_mkt_pric
